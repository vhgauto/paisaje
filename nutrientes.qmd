...
write_csv(metrica_clase_lulc, "datos/metrica_clase_lulc.csv")
...
write_csv(metrica_paisaje_lulc, "datos/metrica_paisaje_lulc.csv")
```
...
read_csv("datos/metrica_clase_lulc.csv", show_col_types = FALSE) |> 
  ...
  full_join(
    rename(d, n_clase = value),
    by = join_by(n_clase)
  ) |>
  pivot_wider(
    names_from = tipo,
    values_from = value,
    id_cols = c(layer, metric)
  ) |> 
  mutate(
